package com.example.jdbc.fruitshop.dao.base;
...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO() {
        // getClass() 获取Class对象，当前我们执行的时new FruitDAOImpl() , 创建的时FruitDAOImpl的实例
        //那么子类构造方法内部首先会调用父类（BaseDAO）的无参构造方法
        //因此此处的getClass()会被执行，但是getClass获取的时FruitDAOImpl的Class
    ...
    private void setValue(Object obj, String property, Object propertyValue) {
        ...
        try {
            //获取 property 这个字符串对应的属性名，比如 "fid" 去找 obj 对象中的 fid 属性
    ...
    protected T load(String sql, Object... params) {
        try {
            ...
            //通过 rs 可以获取结果集的元数据
            //元数据：描述结果集数据的数据，简单说就是这个结果集有哪些列，什么类型等等
